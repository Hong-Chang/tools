...
class CustomObjectsApi(object):
    ...
    def get_tenant_custom_object(self, group, version, tenant, plural, name):
        path_params = {}
        path_params['group'] = group
        path_params['version'] = version
        path_params['tenant'] = tenant
        path_params['plural'] = plural
        ...
        return self.api_client.call_api(
            '/apis/{group}/{version}/tenants/{tenant}/{plural}/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
